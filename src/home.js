  ...
  if (!token) {
    return (
      <>
        ...
        <h2 className="mt-16 text-center lg:text-2xl font-openSans font-bold">
          GET STARTED IN{" "}
          {true ? <span className="text-orange-base">3 EASY </span> : null}{" "}
          STEPS
        </h2>
        <section className="lg:px-10 overflow-x-auto mt-20 grid grid-rows-3">
          <article className="w-full grid lg:grid-cols-2 items-center lg:h-32">
            ...
            >
              ...
              <p className="mt-2 text-gray font-openSans font-thin text-sm ">
                It's quick, easy, and secure. Rest assured that your details are
                safe. Simply click the "Sign Up" button
              </p>
            </div>
          </article>
          ...
          <article className=" grid lg:grid-cols-2  mt-10 lg:mt-0 items-center">
            ...
            <div
              ...
              data-aos-duration="1200"
            >
              <h2 className=" text-center font-bold block font-openSans">
                PAYMENT
              </h2>
        ...
        <Link to="/signup">
          <button
            onClick={topScroll}
            className="mt-10 mx-auto bg-orange-base text-white rounded-lg h-10 w-32 block"
          >
            Sign Up Now
          </button>
        </Link>
